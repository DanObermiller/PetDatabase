...
package com.mycompany.ObermillerWeek1AssignmentSunday;
 ...
 * 1/18/2026
 */
public class ObermillerWeek1AssignmentSunday {
    ...
    private static void updatePet()
    {
        ...
        input = scnr.nextLine();
        //Update pet from ArrayList
        System.out.print("" + pets.get(id).getName() + " " + pets.get(id).getAge() + " changed to ");
        parsed = parseArgument(input);
        pets.get(id).setName(parsed[0]);
        pets.get(id).setAge(Integer.parseInt(parsed[1]));
        
        //Print new name and age
        System.out.println("" + pets.get(id).getName() + " " + pets.get(id).getAge());
